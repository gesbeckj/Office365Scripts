...
$job = Start-AzureRmAutomationRunbook -Name Get-TenantHostedOutboundSpamFilterPolicy -AutomationAccountName "AzureAutomation" -ResourceGroupName "AberdeanPowerBI" -Parameters $params}
