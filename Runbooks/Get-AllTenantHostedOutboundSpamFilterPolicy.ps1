...
$job = Start-AzureRmAutomationRunbook -Name Get-TenantHostedOutboundSpamFilterPolicy -AutomationAccountName "AzureAutomation" -ResourceGroupName "PowerBI" -Parameters $params}
