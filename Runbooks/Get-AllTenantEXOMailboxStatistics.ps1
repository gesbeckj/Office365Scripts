...
$job = Start-AzureRmAutomationRunbook -Name Get-TenantEXOMailboxStatistics -AutomationAccountName "AzureAutomation" -ResourceGroupName "AberdeanPowerBI" -Parameters $params}
