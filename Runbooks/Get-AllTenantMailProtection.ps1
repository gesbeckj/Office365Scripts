...
$job = Start-AzureRmAutomationRunbook -Name "Get-TenantMailProtection" -AutomationAccountName "AzureAutomation" -ResourceGroupName "AberdeanPowerBI" -Parameters $params
