...
$job = Start-AzureRmAutomationRunbook -Name Get-TenantAtpPolicyForO365 -AutomationAccountName "AzureAutomation" -ResourceGroupName "AberdeanPowerBI" -Parameters $params}
