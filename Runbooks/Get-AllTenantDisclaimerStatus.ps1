...
$job = Start-AzureRmAutomationRunbook -Name "Get-TenantDisclaimerStatus" -AutomationAccountName "AzureAutomation" -ResourceGroupName "AberdeanPowerBI" -Parameters $params
